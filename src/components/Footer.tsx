...
const Footer = () => {
  return (
    <footer className="border-t border-border py-6" style={{ paddingBottom: "calc(1.5rem + env(safe-area-inset-bottom, 0px))" }}>
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-5 text-center lg:text-left">
        ...
        <div className="flex flex-col items-center lg:items-start gap-1">
          ...
          <span className="text-[13px] text-muted-foreground">Powered by n8n + GPT-4o</span>
        </div>
